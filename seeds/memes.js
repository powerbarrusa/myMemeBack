  ...
  return knex('memes').del()
    .then(function () {
      ...
      return knex('memes').insert([
        ...
        {id: 3, image_url: "https://comicsandmemes.com/wp-content/uploads/blank-meme-template-018-office-space-if-you-could-just.png", top_text: "V3 I'm on top!", bottom_text: "V3 I'm on bottom!"}
      ]);
    });
};
