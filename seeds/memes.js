  ...
  return knex('memes').del()
    .then(function () {
      ...
      return knex('memes').insert([
        ...
        {id: 2, image_url: "http://memebomb.net/wp-content/uploads/2018/10/blank-meme-maker-2.jpg", top_text: "That feeling when", bottom_text: "you decide to use materialize"},
